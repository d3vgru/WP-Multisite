...
if(is_admin()){
    ...
    function wpv_get_filter_post_relationship_summary($view_settings) {
        ...
        if ($view_settings['post_relationship_mode'] == 'current_page') {
            _e('Select related posts that are a <strong>child</strong> of the <strong>post where this View is inserted</strong>.', 'wpv-view');
		} else if ($view_settings['post_relationship_mode'] == 'parent_view') {
            _e('Select related posts that are a <strong>child</strong> to the <strong>Post set by parent View</strong>.', 'wpv-view');
        } else {
            ...
            echo sprintf(__('Select related posts that are a child of <strong>%s</strong>.', 'wpv-view'), $selected_title);
        }
