...
function wpv_add_meta_key($args, $view_settings = null) {
	...
	<div class="meta_key_div" style="margin-left: 20px;">
		...
		<a style="cursor: pointer" onclick="show_custom_field_compare_functions()"><?php _e('Compare functions', 'wpv-view'); ?></a>
		...
		<div class="show_custom_field_compare_functions" style="display:none">
