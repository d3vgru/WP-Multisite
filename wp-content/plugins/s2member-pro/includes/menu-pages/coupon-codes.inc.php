				...
				public function __construct ()
					{
						...
						echo '<em>To actually credit your affiliates, please check your Dashboard here: <code>s2Member -> API / Tracking</code>.</em><br /><br />' . "\n";
						...
						echo '<li><code>%%affiliate_id%%</code> = This is the end of the Affiliate Coupon Code <em>( i.e. the referring affiliate\'s ID )</em>.</li>' . "\n";
