		...
		function ws_plugin__s2member_pro_default_options ($default_options = array ())
			{
				...
				"pro_ccbill_client_id" => "", "pro_ccbill_client_sid" => "0000", "pro_ccbill_form_name" => "", "pro_ccbill_dl_user" => "", "pro_ccbill_dl_pass" => "", "pro_ccbill_salt_key" => "", "pro_ccbill_return_template_header" => "",/**/
						...
						if (isset ($pro_default_options[$key]) || preg_match ("/^pro_/", $key))
							{
								...
								/**/
									...
									$value = $pro_default_options[$key];
								/**/
								else if (preg_match ("/^pro_ccbill_(?:client_id|client_sid|form_name|dl_user|dl_pass|salt_key|return_template_header)$/", $key) && (!is_string ($value) || !strlen ($value)))
									$value = $pro_default_options[$key];
								/**/
